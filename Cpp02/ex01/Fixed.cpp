...
Fixed::Fixed(int const value)
{
	...
	this->fixed_int_value = (value << this->frac_bits); //Побитовый сдвиг влево на 8 позиций битов
}
...
Fixed::Fixed(float const value)
{
	...
	this->fixed_int_value = roundf(value * (1 << this->frac_bits)); //Преобразование значения FLOAT в хранимое INT
}
...
{
	return ((float)this->fixed_int_value / (float)(1 << this->frac_bits)); //Преобразует хранимое INT в FLOAT для вывода
}

//Преобразование Fixed в Int
int Fixed::toInt(void) const
{
	return (this->fixed_int_value >> this->frac_bits); //Побитовый сдвиг вправо на 8 позиций битов
}
